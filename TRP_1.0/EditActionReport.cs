...
namespace TRP_1._0
{
    public partial class EditActionReport : Form
    {
        ...
        private void EditActionReport_Load(object sender, EventArgs e)
        {
            ...
            var activeUser = (from u in db.Users where u.Id==userID select u).FirstOrDefault();
          
            //userID = use.Id;
            labelActive.Text = activeUser.Name;
        ...
        {
            btnAddActionLine.Enabled = false;
